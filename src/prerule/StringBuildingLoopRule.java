...
public class StringBuildingLoopRule {
	...
	public String handleText(char[] txt, int position) {
		/*
		 * corner case in cc.mallet.pipe.CharSequenceRemoveHTML.java Using StringBuilder
		 * if conversion to stream is not possible
		 */
	...
	public int distinguishBetweenMathPlusAndConcat(String input) {
		List<Integer> collectionOfints = new ArrayList<>();
		/*
		 * The operator in the loop is not concatenation, but is a normal arithmetic
		 * operation
		 */
