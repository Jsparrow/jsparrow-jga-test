...
public class DateDeprecatedRule {
	...
	private Date /* name leading comment */ fieldWithComments /* name trailing comment */ = /* init leading comment */ new /*
																															 * init
																															 * inner
																															 * comment
																															 */ Date(
			99, 1, 1) /* init trailing comment */; // trailing comment
	...
	public void savingComments() {
		...
		Date /* leading name comment */ date /* trailing name comment */ = /* leading init comment */new /*
																											 * inner
																											 * init
																											 * comment
																											 */ Date(99,
				1, 1)/* trailing init comment */ ; // trailing statement comment
		...
		if (date != null) {
			// leading comment
			date /* name comment */ = /* leading initializer comment */ new /* inner initializer comment */ Date(90, 1,
					31) /* trailing initializer comment */ ; // trailing comment
		}
	}
